    ...
    <>
      <section className="relative px-4 sm:px-8 md:px-18 py-10 sm:py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
          ...
          >
            Discover delicious meals from around the world. Search by ingredient,
            browse categories, or find your next favorite dish from our collection
      ...
      {/* Search Results - Below Entire Hero Section */}
      <div className="px-4 sm:px-8 md:px-18 pb-10">
        {loading && (
        ...
        {!loading && searchTerm.trim() && meals.length === 0 && (
